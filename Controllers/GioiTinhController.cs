...
namespace BTLNHOM27.Controllers
{
    public class GioiTinhController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GioiTinhID,NameGT")] GioiTinh gioiTinh)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("GioiTinhID,NameGT")] GioiTinh gioiTinh)
        {
        ...
        {
          return (_context.GioiTinh?.Any(e => e.GioiTinhID == id)).GetValueOrDefault();
        }
    }
}
